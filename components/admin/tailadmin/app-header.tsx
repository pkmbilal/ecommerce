...
type TailAdminHeaderProps = {
  email: string;
  fullName?: string;
};

export function TailAdminHeader({ email, fullName }: TailAdminHeaderProps) {
    ...
    <header className="sticky top-0 z-30 flex w-full border-gray-200 bg-white lg:border-b">
      <div className="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
        <div className="flex w-full items-center justify-between gap-2 border-b border-gray-200 px-3 py-3 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4">
          ...
          <Link href="/admin" className="font-bold text-gray-900 lg:hidden">
            SAHA Admin
          </Link>
            ...
            <Form action="/admin/products" scroll={false}>
              <div className="relative">
                ...
                <input
                  ...
                  className="h-11 w-full rounded-lg border border-gray-200 bg-transparent py-2.5 pl-12 pr-20 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-none focus:ring-3 focus:ring-brand-500/10 xl:w-[430px]"
                />
